...
def json_equel(Json_old, Json_new):
    if json.dumps(json.loads(Json_old)) == json.dumps(json.loads(Json_new)):
        return "The JSON objects are equal"
    else:
        return 'Not'
...
print(json_equel(json_old, json_new))
