json_old = {
    ...
    'data': {
        ...
        'client': {
            'id': 130345867, 'name': 'Клиент', 'phone': '79111111111', 
            'success_visits_count': 2, 'fail_visits_count': 0
        }, 
        'clients_count': 1, 
...
json_new = {
    ...
    'data': {
        ...
        'company_id': 111111, 
        'services': [
            {'id': 22222225, 'title': 'Стрижка', 'cost': 1500, 'cost_per_unit': 1500, 'first_cost': 1500, 'amount': 1}
        ], 
        'goods_transactions': [], 
        'staff': {'id': 1819441, 'name': 'Мастер'}, 
        'client': {
...
def find_differences(old_json, new_json, keys_to_compare):
    differences = {}
    for key in keys_to_compare:
        
        old_value = old_json['data'][key] if key in old_json['data'] else old_json[key]
        new_value = new_json['data'][key] if key in new_json['data'] else new_json[key]
